...
//引入子组件
import TheTable from './Table.js';
import TheForm from './Form.js';
import TheLayout from './Layout.js';
			...
			<div>
				<div id="leftMenu">
					...
					<Menu theme='dark' onClick={this.handleClick.bind(this)} style={{ width: 200}} defaultOpenKeys={['sub1','sub2']} defaultSelectedKeys={[this.state.current]} mode="inline">
						<Menu.Item key="0"><Link to="/introduce"><Icon type='mail' /><span>About</span></Link></Menu.Item>
						<SubMenu key="sub1" title={<span><Icon type="bars" /><span>点击展开</span></span>}>
							...
							<Menu.Item key="3"><Link to="/layout">布局</Link></Menu.Item>
						</SubMenu>
					</Menu>
				</div>
				<div id="rightWrap">
